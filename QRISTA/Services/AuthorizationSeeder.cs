...
namespace QRB.Services
{
    public class AuthorizationSeeder
    {
        ...
        private async Task SeedPermissions()
        {
            var permissions = new[]
            {
                new AppPermission { Id = "user-management", Name = "Quản lý người dùng", Description = "Thêm, sửa, xóa người dùng", Category = "User Management" },
                new AppPermission { Id = "product-management", Name = "Quản lý sản phẩm", Description = "Quản lý menu và sản phẩm", Category = "Product Management" },
                new AppPermission { Id = "order-management", Name = "Quản lý đơn hàng", Description = "Xem và xử lý đơn hàng", Category = "Order Management" },
                new AppPermission { Id = "inventory-management", Name = "Quản lý kho", Description = "Quản lý tồn kho và nhập xuất", Category = "Inventory Management" },
                new AppPermission { Id = "branch-management", Name = "Quản lý chi nhánh", Description = "Thêm, sửa, xóa chi nhánh", Category = "Branch Management" },
                new AppPermission { Id = "promotion-management", Name = "Quản lý khuyến mãi", Description = "Tạo và quản lý ưu đãi", Category = "Promotion Management" },
                new AppPermission { Id = "reporting", Name = "Báo cáo thống kê", Description = "Xem báo cáo và thống kê", Category = "Reporting" },
                new AppPermission { Id = "system-config", Name = "Cấu hình hệ thống", Description = "Cấu hình tham số hệ thống", Category = "System Configuration" },
                new AppPermission { Id = "payment-management", Name = "Quản lý thanh toán", Description = "Xử lý thanh toán và hoàn tiền", Category = "Payment Management" },
                new AppPermission { Id = "customer-management", Name = "Quản lý khách hàng", Description = "Quản lý thông tin khách hàng", Category = "Customer Management" },
                new AppPermission { Id = "order-create", Name = "Tạo đơn hàng", Description = "Tạo đơn hàng mới", Category = "Order Management" },
                new AppPermission { Id = "order-view", Name = "Xem đơn hàng", Description = "Xem thông tin đơn hàng", Category = "Order Management" },
                new AppPermission { Id = "menu-view", Name = "Xem menu", Description = "Xem danh sách sản phẩm", Category = "Product Management" },
                new AppPermission { Id = "cashier-operations", Name = "Thao tác thu ngân", Description = "Thu tiền và in hóa đơn", Category = "Payment Management" }
            };
